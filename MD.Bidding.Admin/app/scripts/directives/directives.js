    ...
    return {
        link: function(scope, element) {
            var listener = function(event, toState, toParams, fromState, fromParams) {
                // Default title
                var title = 'Integrated Auction and Bidding System';
                // Create your own title pattern
                if (toState.data && toState.data.pageTitle) title = toState.data.pageTitle + ' - Integrated Auction and Bidding System';
                $timeout(function() {
                    element.text(title);
                });
            };
